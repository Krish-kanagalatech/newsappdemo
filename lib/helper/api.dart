...
class Api {
  static String businessId = '100001';
  static String baseURL = "http://206.189.143.159/news-demo/";
  static String popular = baseURL + "api.php?get=top&business_id=$businessId";
  static String breaking = baseURL + "api.php?get=breaking&business_id=$businessId";
  static String trends = baseURL + "api.php?get=trends&business_id=$businessId";
